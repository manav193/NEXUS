...
test("canonical fingerprint ignores object key insertion order",()=>{const a=createAction({tool:"github",operation:"read_repository",parameters:{repo:"NEXUS",scope:"metadata"}}); const b=createAction({operation:"read_repository",tool:"github",parameters:{scope:"metadata",repo:"NEXUS"}}); assert.equal(fingerprintAction(a),fingerprintAction(b));});
